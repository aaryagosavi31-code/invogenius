...
const Login = () => {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-background">
      ...
      <div className="absolute top-1/3 left-1/3 h-72 w-72 rounded-full bg-primary/10 blur-[100px]" />
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        <div className="glass-card p-8">
          ...
          <h2 className="mb-2 text-center text-xl font-semibold text-foreground">Welcome back</h2>
